...
<body>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_desc clearfix">
            <span>Encens</span>
            <a href="cart.html">
                <h2>Marie qui defait des noeuds</h2>
            </a>
            <p class="product-price"><span class="old-price">15.00€</span> 11.00€</p>
            <p class="product-desc">Description: <br/>Cet encens s'emploie pour dénouer les situations inextricables et difficiles.

Les "noeuds" sont des blocages énergétiques de toutes sortes: sentimentaux, administratifs, financiers, familiaux...

L'encens Marie qui défait les noeuds peut donc s'utiliser dans n'importe quelle situation de souffrance.
</p>

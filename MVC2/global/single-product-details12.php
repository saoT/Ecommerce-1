    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="../templates/images/resine/olibanum-resine-encens-larmes-en-vrac-100-gr.jpg" alt="">
                <img src="img/.jpg" alt="">
            </div>
        </div>
        ...
        <div class="single_product_desc clearfix">
            ...
            <p class="product-desc">Description: <br/> - Résine, gomme ou encens en vrac pour la préparation de parfum , d'encens à brûler ou autre préparation, mise en sachets à l'Herboristerie du Valmont., mise en sachets à l'Herboristerie du Valmont.

- Matière première 100% pure et naturelle.</p>

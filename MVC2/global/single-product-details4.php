    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="../templates/images/plantes/bleuet-petales-bio-50-gr.jpg" alt="">
                <img src="img/.jpg" alt="">
            </div>
        </div>
        ...
        <div class="single_product_desc clearfix">
            ...
            <p class="product-desc">Description: Le bleuet est une plante herbacée bisanuelle à racine pivotante couverte de nombreuses radicelles. La tige est raide, striée, rameuse, duveteuse, elle porte des feuilles alternes sans stipules, étroites, simples ou dentées, légèrement, cotoneuses dessous.

Les fleurs, qui apparaissent de mai à août, d'un très beau bleu céleste, sont des grands capitules solidaires. Le fruit est comprimé et blanchâtre.
</p>

    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_thumb clearfix">
            <div class="product_thumbnail_slides owl-carousel">
                <img src="../templates/images/resine/plante_resine_encens-oliban.jpg" alt="">
                <img src="img/.jpg" alt="">
            </div>
        </div>
        ...
        <div class="single_product_desc clearfix">
            ...
            <p class="product-desc">L'Oliban est connu depuis l’Antiquité pour ses propriétés désinfectantes et curatives, mais aussi pour son utilisation dans les cérémonies religieuses, associé à d’autres résines (liturgie indienne, bouddhiste, ou catholique).
Il permet d’assainir l’air pour chasser les mauvaises odeurs ou encore pour purifier la chambre d’un malade. Son odeur suave, sensuelle, subtilement vanillée, facilite la relaxation et la réflexion</p>
